...
public class EmpController {
  ...
  @PostMapping("/add")
  public ResponseEntity<ResponseDto<List<EmployeeResponseDto>>> addEmployee(
      @RequestBody List<EmpDto> empList) {
  ...
  public ResponseEntity<ResponseDto<List<EmployeeResponseDto>>> updateEmployee(@RequestBody List<EmpDto> empDtoList) {
      return empService.updateEmployee(empDtoList);
  }
